...
namespace FieldValidatorAPI
{
    ...
    public delegate bool StringLengthValidDel(string fieeldVal, int min, int max);
    ...
    public class CommondFieldValidatorFunctions
    {
        ...
        public static StringLengthValidDel StringLengthFieldValidDel
        {
            get
            {
                if (_stringLengthValidDel == null)
                    _stringLengthValidDel = new StringLengthValidDel(StringLengthFieldValidDel);
        ...
        public static PatternMatchValidDel PatternMatchFieldValidDel
        {
            get
            {
                if (_patternMatchValidDel == null)
                    _patternMatchValidDel = new PatternMatchValidDel(PatternMatchFieldValidDel);
        ...
        private static bool FieldPatternValid(string fieldVal, string regualrExpressionPattern)
        {
            Regex regex = new Regex(regualrExpressionPattern);
